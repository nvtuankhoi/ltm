...
public class HeCoSo2Va16 {
    public static void main(String[] args) throws Exception {
        ...
        String code = "B22DCCN466;UsLuWWET ";
        out.writeUTF(code);
        out.flush();
        int n = in.readInt();
...
/*
 * [Mã câu hỏi (qCode): UsLuWWET]. Một chương trình server cho phép kết nối qua
 ...
 * c. Chuyển đổi số nguyên nhận được sang hệ nhị phân và thập lục phân, ghép
 * thành chuỗi và gửi lên server. Ví dụ: 15226 sẽ thành "11101101111010;3B7A"
