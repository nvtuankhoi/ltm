...
public class SXTheoVTGoc {
    public static void main(String[] args) throws IOException {
        ...
        int sP = 2207;
        // a.
        String code = ";B22DCCN466;aKZwZxWk";
...
/*
 * [Mã câu hỏi (qCode): aKZwZxWk]. Một chương trình server cho phép giao tiếp
 ...
 * b. Nhận thông điệp là một chuỗi từ server theo định dạng "requestId;string",
 * với:
 * --- requestId là chuỗi ngẫu nhiên duy nhất.
 * ---string là một chuỗi chứa các chuỗi con bị thay đổi vị trí. Ví dụ:
 * "veM3xgA1g:4,IPFfgEanY:5,aWXlSzDwe:2,PHupvPc:3,PR3gH8ahN:6,UEEKHLIt:7,M6dpWTE:1"
 * c. Xử lý chuỗi xáo trộn và gửi về chuỗi sau khi sắp xếp: "requestId;string".
 * Ví dụ chuỗi đã được xử lý:
 * "M6dpWTE,aWXlSzDwe,PHupvPc,veM3xgA1g,IPFfgEanY,PR3gH8ahN,UEEKHLIt"
